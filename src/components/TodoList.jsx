...
const TodoList = () => {
    ...
    return (
        <div>
            <div className="bgvert">

                <h1 className="text-white text-uppercase text-center">To do List</h1>
            <div className="form-group mt-5 mb-5">
                <input type="text"className="d-block form-control w-75 mx-auto" onKeyPress={addToDo} />
            </div>
            <div className="d-flex justify-content-center">
                <button className={menu === "all" ? "btn btn-outline-primary active" : "btn btn-outline-primary"} onClick={() => setMenu("all")}>Tous</button>
                <button className={menu === "todo" ? "btn btn-outline-warning active mx-2" : "btn btn-outline-warning mx-2"} onClick={() => setMenu("todo")}>Fait</button>
                <button className={menu === "done" ? "btn btn-outline-danger" : "btn btn-outline-danger"} onClick={() => setMenu("done")}>A Faire</button>
            </div>
            <div className="mt-5">
